...
public class LearningTreeMap {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				countries.replace("Indonesia", "Bandung"));
		System.out.println(countries);
		System.out.println(
				countries.replace("Thailand", "Bangkok"));
		System.out.println(countries);
		
		System.out.println(countries.get("Indonesia"));
		...
		System.out.println(countries.containsValue("Bandung"));
		System.out.println(
